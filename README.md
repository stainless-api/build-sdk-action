  ...
  preview:
    ...
    steps:
      ...
      - name: Run preview builds
        uses: stainless-api/build-sdk-action/preview@1f0bfd7f5c377a9b94a9cb35f8dabcb8ce78e1fd
        with:
  ...
  merge:
    ...
    steps:
      ...
      - name: Run merge build
        uses: stainless-api/build-sdk-action/merge@1f0bfd7f5c377a9b94a9cb35f8dabcb8ce78e1fd
        with:
          stainless_api_key: ${{ secrets.STAINLESS_API_KEY }}
          org: ${{ env.STAINLESS_ORG }}
          project: ${{ env.STAINLESS_PROJECT }}
