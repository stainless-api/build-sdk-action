...
export declare namespace CommitBuildStep {
    ...
    namespace Completed {
        interface CommitMissingShape {
            conclusion: 'cancelled' | 'timed_out' | 'fatal' | 'payment_required' | 'noop' | 'merge_conflict' | 'version_bump';
        }
