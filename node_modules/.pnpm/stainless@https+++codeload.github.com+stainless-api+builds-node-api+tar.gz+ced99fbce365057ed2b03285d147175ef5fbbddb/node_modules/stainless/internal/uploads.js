...
const file_node_js_1 = require("./shims/file.node.js");
...
function makeFile(fileBits, fileName, options) {
    if (typeof file_node_js_1.File === 'undefined') {
        throw new Error('`File` is not defined as a global which is required for file uploads');
    }
    return new file_node_js_1.File(fileBits, fileName ?? 'unknown_file', options);
}
...
const isNamedBlob = (value) => (file_node_js_1.File && value instanceof file_node_js_1.File) || (value instanceof Blob && 'name' in value);
