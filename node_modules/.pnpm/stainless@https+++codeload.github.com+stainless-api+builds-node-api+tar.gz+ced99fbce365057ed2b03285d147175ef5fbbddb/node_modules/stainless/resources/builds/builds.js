...
class Builds extends resource_1.APIResource {
     ...
     */
    create(body, options) {
        return this._client.post('/api/spec', (0, uploads_1.multipartFormRequestOptions)({ body, ...options, headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]) }, this._client));
    }
    /**
